...
:: TODO: Make a variable for captureChaptersOnTimer.sh that causes it to ignore the status file and just grab everything now?
:: Can't I just set the wait time to one second?
...
%captureCommand% --wait-time='1' --id='/fiction/10073/the-wandering-inn' --name='wanderingInn'
...
%captureCommand% --wait-time='1' --name='theNewWorld' --id='/fiction/12024/the-new-world'
